    ...
    class Program
    {
        static void Main()
        {
            game:
            {
                ...
                int[] xPoints;
                xPoints = new [] { 20, 19, 18, 17, 16, 15, 14, 13 };
                int[] yPoints;
                yPoints = new [] { 20, 20, 20, 20, 20, 20, 20, 20 };
                ...
                while (alive)
                {
					if (!pelletOn)
					{
						...
						{
							collide |= xPoints[l] == pelletX & yPoints[l] == pelletY;
						}
						if (collide)
						{
							pelletOn = false;
                    ...
                    for (int l = (xPoints.Length - 1); l > 1; l--)
                    {
						alive &= !(xPoints[l] == xPoints[0] & yPoints[l] == yPoints[0]);
                ...
                for (int i = 0; i < 1; i++)
                {
					for (int j = 0, colorsLength = colors.Length; j < colorsLength; j++)
					{
						var color = colors[j];
